...
# Import functions
from functions_old import Index_Maps, coordinateDictionaries, makeMap, areaSeries
from functions_old import droughtArea
...
mask = grid * 0 + 1
state_arrays = gdal.Open('data/rasters/us_states_0_25.tif').ReadAsArray()
